...
jq '{required: .statistical_validation_required, universe: .selection_universe_hash, metric_universe: .candidate_metric_values_hash, metric_count: .metric_value_count, missing_metric_count: .missing_metric_count, evidence: .statistical_evidence_hash, summary_bootstrap_p: .summary_metric_max_bootstrap_p_value, compatibility_p: .white_reality_check_p_value, method: .white_reality_check_method, limitations: .promotion_grade_limitations, gate: .statistical_gate_result, reasons: .statistical_gate_fail_reasons}' "$DATA_ROOT/paper/reports/research/sma_filter_v1_2026_05/backtest_report.json"
