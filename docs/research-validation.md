...
- `deployment_tier` defaults to `research_only` when absent. Production-bound values such as `paper_candidate`, `live_dry_run_candidate`, and `small_live_candidate` activate the repo-owned production calibration policy.
- `acceptance_gate`
