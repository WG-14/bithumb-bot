...
def _production_candidate(*, attach_stress_suite: bool = True, **overrides):
    ...
    payload = _candidate(
        ...
        primary_scenario_id="scenario_base",
        ...
        aggregate_gate_policy="single_scenario",
        ...
        policy_contract_hash="sha256:policy-contract",
        decision_input_bundle_hash="sha256:bundle",
        market_feature_hash="sha256:market-feature",
        final_exit_decision_input_hash="sha256:final-exit-input",
        ...
        runtime_decision_request_hash="sha256:runtime-request",
        runtime_strategy_set_manifest_hash="sha256:strategy-set",
        approved_profile_hash="sha256:approved-profile",
        code_provenance={"source": "git", "commit": "abc123"},
        strategy_parameters_hash="sha256:strategy-parameters",
        fee_authority_hash="sha256:fee-authority",
        fee_model_hash="sha256:fee-model",
        order_rules_hash="sha256:order-rules",
        slippage_model_hash="sha256:slippage-model",
    )
...
def _attach_statistical_evidence(
    ...
    registry_base = {
        ...
        "final_holdout_reuse_key_hash_v1": "sha256:final-holdout-identity",
        "final_holdout_reuse_key_hash": "sha256:final-holdout-v2",
        "final_holdout_reuse_key_schema_version": FINAL_HOLDOUT_REUSE_KEY_SCHEMA_VERSION,
        "final_holdout_reuse_key_hash_v2": "sha256:final-holdout-v2",
        "objective_metric": str(evidence.get("primary_metric") or "net_excess_return"),
        "parameter_space_hash": report.get("parameter_space_hash") or "sha256:parameter-space",
    ...
    registry_fields = {
        ...
        "final_holdout_reuse_key_hash_v1": registry_base["final_holdout_reuse_key_hash_v1"],
        "final_holdout_reuse_key_hash": registry_base["final_holdout_reuse_key_hash"],
        "final_holdout_reuse_key_schema_version": registry_base["final_holdout_reuse_key_schema_version"],
        "final_holdout_reuse_key_hash_v2": registry_base["final_holdout_reuse_key_hash_v2"],
        "objective_metric": registry_base["objective_metric"],
