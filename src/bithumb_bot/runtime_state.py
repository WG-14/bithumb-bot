...
_RECONCILE_METADATA_PRESERVE_KEYS = (
    ...
    "balance_source_quote_currency",
    "balance_source_base_currency",
    "broker_asset_qty",
...
def record_reconcile_result(
    *,
    ...
    payload = _json_with_size_limit(
        ...
        preserve_keys=_RECONCILE_METADATA_PRESERVE_KEYS,
    )
    ...
    with _LOCK:
        ...
        if reason:
            ...
            _STATE.last_reconcile_metadata = _json_with_size_limit(
                existing_metadata,
                max_len=_HEALTH_SUMMARY_MAX_LEN,
                preserve_keys=("startup_gate_reason", "startup_gate_blocked", *_RECONCILE_METADATA_PRESERVE_KEYS),
            )
